...
*変数宣言
***********************************************************/
KEY_STATE button_state[XINPUT_BUTTON_MAX];			//各ボタン入力
...
void InputControl_Update(void)
{
	...
	//コントローラーの入力情報を取得
	GetJoypadXInputState(DX_INPUT_KEY_PAD1, &input_controller);
...
*XINPUT_BUTTON_X							(14)		//Xボタン
*XINPUT_BUTTON_Y							(15)		//Yボタン
*戻り値 ： TRYE(押した瞬間), FALSE(押した瞬間ではない)
***********************************************************/
